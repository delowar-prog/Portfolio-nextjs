  ...
  return (
    <div id='home' className='max-w-contentContainer py-8 md:py-24 mx-auto px-8 md:px-28'>
      <div className='w-full md:w-[80%] my-5'>
        ...
        <motion.p initial={{y:-2, opacity:0}} animate={{y:0, opacity:1}} transition={{duration:0.4, delay:0.4}} className='text-textLight text-md mb-3'>A dedicated Laravel developer with a passion for creating dynamic and user friendly web application. I have completed few projects from design to deployment using Laravel, PHP, Bootstrap, Tailwind, Mysql & MERN technologies with 1 years Job experience.</motion.p>
